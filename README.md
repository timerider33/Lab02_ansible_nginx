...
В папке ansible_logs справочно находится логфайл запуска плейбука (первый раз - инсталлировал nginx, второй раз - просто проверил что система в целевом состоянии)
